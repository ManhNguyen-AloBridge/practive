  ...
  <main>
    <div class="d-flex flex-column flex-shrink-0 p-3 bg-light sidebar ">
      ...
      <ul class="nav nav-pills flex-column mb-auto" id="menu">
        ...
        <li>
          <a href="../../views/pages/admin/list-admin.html" class="nav-link link-dark" id="listAdmin">
            <svg class="bi me-2" width="16" height="16"></svg>
            Danh sách admin
          </a>
        </li>
        <li>
          <a href="../../views/pages/staff/list-staff.html" class="nav-link link-dark" id="listStaff">
            <svg class="bi me-2" width="16" height="16"></svg>
            Danh sách nhân viên
          </a>
        </li>
        <li>
          <a href="../../views/pages/form/list-form.html" class="nav-link link-dark" id="listForm">
            <svg class="bi me-2" width="16" height="16"></svg>
            Danh sách sách form
          </a>
        </li>
